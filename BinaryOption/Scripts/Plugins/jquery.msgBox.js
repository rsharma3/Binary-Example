...
var msgBoxImagePath = "/BinaryOptionQA/Images/"; //Staging Server
//var msgBoxImagePath = "/Images/"; //Local
//var msgBoxImagePath = "/BinaryOptionuat/Images/"; //Client Server
...
function msg(options) {
    ...
    if (options.type != null) {
        switch (options.type) {
            ...
            case "success":
                ...
                options.buttons = options.buttons == null ? [{ value: "Close"}] : options.buttons;
                break;
            default:
                options.title = options.title == null ? "Message" : options.title;
                options.buttons = options.buttons == null ? [{ value: "Close"}] : options.buttons;
    ...
    $(options.buttons).each(function (index, button) {
        if (button.value == "No") {
            buttons += "<input class=\"msgButton inverse\" type=\"button\" name=\"" + button.value + "\" value=\"" + button.value + "\" />";
        } else {
    ...
    var divTitle = "<div class=\"msgBoxTitle\">Binary Option</div>";
