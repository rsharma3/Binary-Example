...
/*----------------------------------------------------------*/
        (function () {
            var $tabsNav = $('.one-third .tabs-nav'),
                $tabsNavLis = $tabsNav.children('li'),
                $tabContent = $('.one-third .tab-content');
            $tabContent.hide();
		...
		(function () {
            var $tabsNav = $('.two-third .tabs-nav'),
                $tabsNavLis = $tabsNav.children('.two-third li'),
                $tabContent = $('.two-third .tab-content');
            $tabContent.hide();
            $tabsNavLis.last().addClass('active').show();
